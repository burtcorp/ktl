...
module Ktl
  class Cluster < Command
    ...
    option :multi_step_migration, type: :boolean, default: false, desc: 'Perform migration in multiple steps, mirroring partitions to new brokers before removing the old'
    def migrate_broker
      with_zk_client do |zk_client|
